...
const PHOTO_GRID_WIDTH = 608
const PHOTO_WIDTH = Math.floor((PHOTO_GRID_WIDTH - PHOTO_GAP) / 2)
const PHOTO_ASPECT_RATIO = 371 / 551
const PHOTO_HEIGHT = Math.floor(PHOTO_WIDTH / PHOTO_ASPECT_RATIO)
...
const PHOTO_GRID_HEIGHT = PHOTO_HEIGHT * 2 + PHOTO_GAP
const AVAILABLE_GRID_HEIGHT = CANVAS_HEIGHT - TOP_AREA - BOTTOM_AREA
const CENTERED_PHOTO_START_Y =
  TOP_AREA + Math.floor((AVAILABLE_GRID_HEIGHT - PHOTO_GRID_HEIGHT) / 2)
const PHOTO_START_Y = CENTERED_PHOTO_START_Y - 120
